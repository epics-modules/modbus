...
drvModbusAsynConfigure("UINT16",   "sim1", 0, 3,  0, 20, 0, 100, "Simulator")

# Word access at Modbus address 20
# Access 20 words as INT16 data type.  
# Function code=3
# drvModbusAsynConfigure("portName", "tcpPortName", slaveAddress, modbusFunction, modbusStartAddress, modbusLength, dataType, pollMsec, "plcType")
drvModbusAsynConfigure("INT16",    "sim1", 0, 3, 20, 20, 4, 100, "Simulator")

# Word access at Modbus address 40
# Access 20 words as INT32_LE data type.  
# Function code=3
# drvModbusAsynConfigure("portName", "tcpPortName", slaveAddress, modbusFunction, modbusStartAddress, modbusLength, dataType, pollMsec, "plcType")
drvModbusAsynConfigure("INT32_LE", "sim1", 0, 3, 40, 20, 5, 100, "Simulator")

# Word access at Modbus address 60
# Access 20 words as INT32_BE data type.  
# Function code=3
# drvModbusAsynConfigure("portName", "tcpPortName", slaveAddress, modbusFunction, modbusStartAddress, modbusLength, dataType, pollMsec, "plcType")
drvModbusAsynConfigure("INT32_BE", "sim1", 0, 3, 60, 20, 6, 100, "Simulator")
